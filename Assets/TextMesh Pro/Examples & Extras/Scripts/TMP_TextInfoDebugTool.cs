...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // GetCost a reference to the text object's textInfo
            ...
            // GetCost the handle size for drawing the various
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                // GetCost Bottom Left and Top Right position of the current character
        ...
        void DrawBounds()
        {
            ...
            // GetCost Bottom Left and Top Right position of each word
